...
class BrandController {
     ...
     */
    static addBrand(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                //Add a new brand using the BrandService
                const result = yield new brand_service_1.BrandService().addBrand(Object.assign({}, request.body));
     ...
     */
    static getBrand(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Fetch brand details using BrandService by brand name
                const result = yield new brand_service_1.BrandService().getBrand(request.params.name);
     ...
     */
    static deleteBrand(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Call the BrandService to delete the brand
                const result = yield new brand_service_1.BrandService().deleteBrand(request.params._id);
    ...
    static uploadImage(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield new brand_service_1.BrandService().uploadImage(request.params.brandId, image);
     ...
     * @throws {Error} - If there is an error during the upload process.
     */
    static uploadVideo(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Retrieve the uploaded file from the request.
                const file = request.file;
                ...
                const result = yield new brand_service_1.BrandService().uploadVideo(request.params.brandId, video);
                // Prepare the response and respond with new brand details and status code 200(success)
     ...
     */
    static markBrandAsPopular(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Get the brand ID from the request parameters.
                const brandId = request.params.brandId;
                // Call the BrandService to mark the brand as popular.
                const updatedBrand = yield new brand_service_1.BrandService().markBrandAsPopular(brandId);
     ...
     */
    static getAllMarkedPopularBrands(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Retrieve all marked popular brands from the BrandService.
                const allMarkedPopularBrands = yield brand_service_1.BrandService.getAllMarkedPopularBrands();
